...
public abstract class AbstractReflectiveMBeanInfoAssembler extends AbstractMBeanInfoAssembler {
    ...
    /**
     * Constant identifier for the units field in a JMX {@link javax.management.Descriptor}.
     */
    protected static final String FIELD_UNITS = "units";

    /**
     * Constant identifier for the metricType field in a JMX {@link javax.management.Descriptor}.
     */
    protected static final String FIELD_METRIC_TYPE = "metricType";

    /**
     * Constant identifier for the custom metricCategory field in a JMX {@link javax.management.Descriptor}.
     */
    ...
    protected ModelMBeanAttributeInfo[] getAttributeInfo(Object managedBean, String beanKey) throws JMException {
        PropertyDescriptor[] props = null;//TODO BeanUtils.getPropertyDescriptors(getClassToExpose(managedBean));
