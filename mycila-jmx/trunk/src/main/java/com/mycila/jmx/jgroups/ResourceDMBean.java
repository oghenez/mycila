    ...
    private void findDescription() {
        ...
        if (mbean != null && mbean.description() != null && mbean.description().trim().length() > 0) {
            ...
            try {
                ...
                throw new AssertionError("Could not reflect field description of this class. Was it removed?");
            }
        }
    }
        ...
        for (Class<?> clazz = getObject().getClass(); clazz != null; clazz = clazz.getSuperclass()) {
            ...
            for (Field field : fields) {
                ...
                if (expose) {
                    ...
                    String descr = attr != null ? attr.description() : "";
                    boolean writable = attr != null ? attr.writable() : false;
