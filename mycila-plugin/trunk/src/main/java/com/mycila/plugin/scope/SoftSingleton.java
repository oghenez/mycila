...
/**
 * Same as {@link com.mycila.plugin.scope.Singleton}, except that the result is put in a Sof reference
 ...
 */
public final class SoftSingleton<T> extends ProviderSkeleton<T> {
