...
class MoreTypes {
    ...
    public static Class<?> getRawType(Type type) {
        if (type instanceof Class<?>) {
            ...
            Assert.checkArgument(rawType instanceof Class,
    ...
    public static boolean equals(Type a, Type b) {
        if (a == b) {
            ...
            return (pa.getOwnerType() == pb.getOwnerType() || (pa.getOwnerType() != null && pa.getOwnerType().equals(pb.getOwnerType())))
    ...
    public static class ParameterizedTypeImpl
        ...
        public ParameterizedTypeImpl(Type ownerType, Type rawType, Type... typeArguments) {
            ...
            if (rawType instanceof Class<?>) {
                ...
                Assert.checkArgument(ownerType != null || rawTypeAsClass.getEnclosingClass() == null,
    ...
    private static void checkNotPrimitive(Type type, String use) {
        Assert.checkArgument(!(type instanceof Class<?>) || !((Class) type).isPrimitive(),
