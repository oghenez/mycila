...
import com.mycila.plugin.spi.internal.util.MoreTypes;
import com.mycila.plugin.spi.internal.util.Types;
...
public class TypeLiteral<T> {
    ...
    public TypeLiteral<?> getSupertype(Class<?> supertype) {
        Assert.checkArgument(supertype.isAssignableFrom(rawType),
    ...
    public TypeLiteral<?> getFieldType(Field field) {
        Assert.checkArgument(field.getDeclaringClass().isAssignableFrom(rawType),
    ...
    public List<TypeLiteral<?>> getParameterTypes(Member methodOrConstructor) {
        ...
        if (methodOrConstructor instanceof Method) {
            ...
            Assert.checkArgument(method.getDeclaringClass().isAssignableFrom(rawType),
                    "%s is not defined by a supertype of %s", method, type);
            genericParameterTypes = method.getGenericParameterTypes();

        } else if (methodOrConstructor instanceof Constructor) {
            Constructor<?> constructor = (Constructor<?>) methodOrConstructor;
            Assert.checkArgument(constructor.getDeclaringClass().isAssignableFrom(rawType),
