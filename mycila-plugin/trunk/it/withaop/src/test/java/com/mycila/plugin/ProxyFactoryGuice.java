...
import static com.google.inject.internal.BytecodeGen.*;
 ...
 */
final class ProxyFactoryGuice<T> implements ConstructionProxyFactory<T> {
    ...
    ProxyFactoryGuice(InjectionPoint injectionPoint, Iterable<MethodAspect> methodAspects) {
    ...
    private static class ProxyConstructor<T> implements ConstructionProxy<T> {
        ...
        @SuppressWarnings("unchecked")
        // the constructor promises to produce 'T's
