...
public final class Messages {
    ...
    public static <R> ListenableFuture<R> createRequest() {
        return new Message<R>(Arrays.asList());
    }

    public static <R> ListenableFuture<R> createRequest(Object parameter) {
        return new Message<R>(Arrays.asList(parameter));
    }

    public static <R> ListenableFuture<R> createRequest(Object... parameters) {
        return new Message<R>(Arrays.asList(parameters));
    }

    public static <R> ListenableFuture<R> createRequest(Iterable<Object> parameters) {
        return new Message<R>(parameters);
    }

    private static final class Message<R> implements ListenableFuture<R>, EventMessage<R> {
        ...
        public ListenableFuture<R> addListener(FutureListener<R> listener) {
