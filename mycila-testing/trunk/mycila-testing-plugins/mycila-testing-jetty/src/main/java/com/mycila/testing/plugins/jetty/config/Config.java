 ...
 * <li>{@link #getServerLifeCycleListenerClass()} as {@link #getServerLifeCycleListener(Map)} instance.</li>
 * </ul>
 */
public interface Config
     ...
     *
     * @param context the context to pass to the {@code ServerLifeCycleListener} class.
     *
     * @return the server lifecycle listener instance.
     */
    ServerLifeCycleListener getServerLifeCycleListener(Map context);
