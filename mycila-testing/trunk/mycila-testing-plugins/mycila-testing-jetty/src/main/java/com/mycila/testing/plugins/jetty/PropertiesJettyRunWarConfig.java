...
public class PropertiesJettyRunWarConfig
    ...
    {
        final String propValue = this.properties.getProperty(PROPERTY_WAR_LOCATION, DEFAULT_WAR_LOCATION);
        final String value = firstNonNull(emptyToNull(propValue), DEFAULT_WAR_LOCATION);
    ...
    {
        final String propValue = this.properties.getProperty(
                PROPERTY_CYCLE_LISTENER_CLASS,
                DEFAULT_CYCLE_LISTENER_CLASS_AS_STRING);
        final String value = firstNonNull(emptyToNull(propValue), DEFAULT_CYCLE_LISTENER_CLASS_AS_STRING);
