...
import com.example.test.SysWarPathJettyRunWarIT.ExternalConfig;
import com.mycila.testing.junit.MycilaJunitRunner;
import com.mycila.testing.plugins.jetty.JettyRunWar;
import com.mycila.testing.plugins.jetty.config.DefaultConfig;

/**
 * Test that the WAR is found by system property expression and loaded.
 */
@RunWith(MycilaJunitRunner.class)
@JettyRunWar(ExternalConfig.class)
public class SysWarPathJettyRunWarIT {
