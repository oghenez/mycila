...
import com.mycila.math.number.jdk7.BigDecimal;
 ...
 * {@link com.mycila.math.number.jdk7.MathContext} object with the proper settings
 * ({@code precision} set to {@code 1}, and the
 * {@code roundingMode} set to the rounding mode in question), and
 * calling {@link com.mycila.math.number.jdk7.BigDecimal#round round} on this number with the
 ...
 * enumeration of rounding mode constants in {@link com.mycila.math.number.jdk7.BigDecimal}
 * ({@link com.mycila.math.number.jdk7.BigDecimal#ROUND_UP}, {@link com.mycila.math.number.jdk7.BigDecimal#ROUND_DOWN},
 * etc. ).
 *
...
enum RoundingMode {
         ...
         *</table>
         */
    UP(com.mycila.math.number.jdk7.BigDecimal.ROUND_UP),
     ...
     * legacy integer rounding mode constant in {@link com.mycila.math.number.jdk7.BigDecimal}.
     *
