...
public class CharCompressDemo {
   ...
   public static void main(String[] args) {
      ...
      System.out.println("Original string in binary:"+origNum.toString(2));
      ...
      System.out.println("Compressed string in binary:"+compNum.toString(2));
...
//         System.out.println(c1+" "+c2+" "+c3+" "+res1+" "+res2);
