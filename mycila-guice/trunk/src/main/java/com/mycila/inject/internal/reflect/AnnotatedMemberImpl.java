 ...
 */
final class AnnotatedMemberImpl<A extends Member & AnnotatedElement> implements Member, AnnotatedElement {

    private final A member;

    AnnotatedMemberImpl(A member) {
        this.member = member;
    }
    ...
    public boolean equals(Object o) {
        ...
        AnnotatedMemberImpl that = (AnnotatedMemberImpl<?>) o;
